  ...
  return (
    ...
    >
      <div className="relative">
          ...
          onClick={() => setOpen(v => !v)}
          className="w-full flex items-center space-x-3 bg-white/80 backdrop-blur-lg border border-gray-200 shadow-lg text-gray-900 rounded-md px-4 py-3 font-medium">
